...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 81ae9e54-1409-45e5-9552-fd7eaaa8c2ad
```

> `81ae9e54-1409-45e5-9552-fd7eaaa8c2ad` is the password of the certificate, you can change it to any password you want.
